...
with tf.Session() as sess:
    net.train(sess, epochs=epochs, learning_rate= 1e-3, pipeline=pipeline, training_data=training_data, validation_data=validation_data,
              SGDR=True, dropout=0.3, checkpoint=None, save=None)
